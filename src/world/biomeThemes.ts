...
const FROZEN_WASTES: BiomeTheme = {
  ...
  sunColor: 0xd8e8ff,
  sunIntensity: 1.95,
  terrainLowR: 0.48, terrainLowG: 0.54, terrainLowB: 0.60,
  terrainHighR: 0.82, terrainHighG: 0.88, terrainHighB: 0.94,
...
const GLASS_SEA: BiomeTheme = {
  ...
  skyColor: 0x707888,
  fogColor: 0x808898,
  stressColor: 0x484c5a,
  ambientColor: 0xffffff,
  ambientIntensity: 0.78,
  hemiSkyColor: 0xeef0f8,
  hemiGroundColor: 0x8088a0,
  hemiIntensity: 1.05,
  sunColor: 0xffffff,
  sunIntensity: 2.65,
  terrainLowR: 0.62, terrainLowG: 0.66, terrainLowB: 0.74,
  terrainHighR: 0.92, terrainHighG: 0.94, terrainHighB: 1.00,
  terrainEmissive: 0x202830,
  terrainEmissiveIntensity: 0.18,
  rockColor: 0x8088a0,
  rockLightColor: 0xb0b8c8,
  rockDarkColor: 0x606878,
  hullColor: 0x282a30,
  hullRustColor: 0x6a7280,
  debrisColor: 0x80889a,
  bloomStrength: 0.70,
  bloomRadius: 0.5,
  bloomThreshold: 0.55,
  particleTint: 0xeef0f8,
};
...
const FROZEN_HELLSCAPE: BiomeTheme = {
  ...
  sunColor: 0xffd0a0,
  sunIntensity: 2.10,
  terrainLowR: 0.32, terrainLowG: 0.22, terrainLowB: 0.18,
  terrainHighR: 0.78, terrainHighG: 0.82, terrainHighB: 0.92,
